...
// /recruit/:recruitPostId/apply Page 렌더링 방식 : SSG로 하려고 했으나 이슈로 인해 SSR
...
// ? SSR이 적당하긴한데 여러 기능 사용을 위해서 generateStaticParams에 100개의 id를 던져서 100개의 페이지가 변하지 않는다고 가정하고 정적으로 미리 만들어두는 것임)
